...
htmlhelp_basename = 'ReviewGraphMiningDatasetIOLibrarydoc'
...
latex_documents = [
    (master_doc, 'ReviewGraphMiningDatasetIOLibrary.tex', u'Review Graph Mining Dataset I/O Library Documentation',
...
man_pages = [
    (master_doc, 'reviewgraphminingdatasetiolibrary', u'Review Graph Mining Dataset I/O Library Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ReviewGraphMiningDatasetIOLibrary', u'Review Graph Mining Dataset I/O Library Documentation',
     author, 'ReviewGraphMiningDatasetIOLibrary', 'One line description of project.',
     'Miscellaneous'),
]
